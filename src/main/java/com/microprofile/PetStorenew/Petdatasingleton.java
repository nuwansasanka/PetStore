...
public class Petdatasingleton {
    private static  Petdatasingleton myInstance;
    public List<Pet> pets = new ArrayList<Pet>();
    Pet pet1 = new Pet();
    Pet pet2 = new Pet();
    Pet pet3 = new Pet();

    private Petdatasingleton() {
        pet1.setPetId(1);
        pet1.setPetAge(3);
    ...
    public static  Petdatasingleton getInstance() {
        if (myInstance == null)
            myInstance = new  Petdatasingleton();
        return myInstance;
    }
